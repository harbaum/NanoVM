...
// nanovm/nibo/drivers/*
#define NATIVE_CLASS_NIBO_BOT             (NATIVE_CLASS_BASE+12)
#define NATIVE_CLASS_NIBO_CLOCK           (NATIVE_CLASS_BASE+13)
#define NATIVE_CLASS_NIBO_GRAPHICDISPLAY  (NATIVE_CLASS_BASE+14)
#define NATIVE_CLASS_NIBO_DISTANCESENSOR  (NATIVE_CLASS_BASE+15)
#define NATIVE_CLASS_NIBO_EDGEDETECTOR    (NATIVE_CLASS_BASE+16)
#define NATIVE_CLASS_NIBO_IRTRANSCEIVER   (NATIVE_CLASS_BASE+17)
#define NATIVE_CLASS_NIBO_TEXTDISPLAY     (NATIVE_CLASS_BASE+18)
#define NATIVE_CLASS_NIBO_LEDS            (NATIVE_CLASS_BASE+19)
//#define NATIVE_CLASS_  (NATIVE_CLASS_BASE+20)
#define NATIVE_CLASS_NIBO_LINEDETECTOR    (NATIVE_CLASS_BASE+21)
#define NATIVE_CLASS_NIBO_MOTOR           (NATIVE_CLASS_BASE+22)
//#define NATIVE_CLASS_  (NATIVE_CLASS_BASE+23)
//#define NATIVE_CLASS_  (NATIVE_CLASS_BASE+24)
//#define NATIVE_CLASS_  (NATIVE_CLASS_BASE+25)
#define NATIVE_CLASS_NIBO_WHEELENCODER    (NATIVE_CLASS_BASE+26)
